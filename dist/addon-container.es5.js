...
var AddonContainer = function (_EventEmitter) {
  ...
  function AddonContainer() {
    ...
    ['saveData', 'request', 'addTransaction', 'editTransaction', 'addInstitution', 'addManualInstitution', 'addManualAccount', 'addInvestment', 'editInstitution', 'editAsset', 'editLiability', 'deleteInstitution', 'deleteAsset', 'deleteLiability', 'downloadDocument', 'downloadFile', 'upgradePremium', 'getSharings', 'switchUser', 'printPage', 'setLoadingStatus', 'addGroupPopup'].forEach(function (event) {
